...
To diagnose and fix the compilation problem, an automated compilation-repair tool available on the LaTeX platform (Overleaf.com) was used. The tool successfully restored compilation and allowed the PDF to be generated. We then used these files that successfully compiled in our local LaTex workflow.
